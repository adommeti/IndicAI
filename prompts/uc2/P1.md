...
<!-- Run: runbooks/run-prompt.sh uc2 P1  (or paste into the Codex TUI) -->

Read AGENTS.md and docs/adr/0003. Create apps/training_localizer/terminology/glossary.yaml (≥ 40 entries: keep_english terms like MFA, phishing, VPN, DLP, product names; and approved renderings for ≥ 15 compliance terms per language — mark these as DRAFT for reviewer confirmation) and approved_renderings.yaml (5 LOCKED compliance statements with approved hi/te/ta renderings, DRAFT).
